...
const WonOrderView = createMemo<any>( ( ) => {
    ...
    const handleBack = () => {
        history.push(route('Bidding.Order.BidsWon'));
    };
                    ...
                    <>
                        <Row>
                            ...
                            <Col sm={ 7 } layout={ 'column' }>
                                ...
                                <ActionButtons>
                                    { <PrimaryButton className={ 'btn-lg' } color={ 'grey' } onClick={ ( e ) => redirectToView(e, item) }>Go To Full Order Page</PrimaryButton> }
                                </ActionButtons>
                                <InlineFlex padding={ '10px 0' } layout={ 'column' }>
                                    ...
                                    <TextLine title={ 'Status: ' } content="WON"/>
                                </InlineFlex>
                                <InlineFlex padding={ '10px 0' } layout={ 'column' }>
    ...
    displayName: 'WonOrderView'
});

export default WonOrderView;
